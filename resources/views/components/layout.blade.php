...
<div class="min-h-full">
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex h-16 items-center justify-between">
                <div class="flex items-center">
                    <div class="shrink-0">
                        <a href="/">
                            <img class="size-8 bg-white" src="{{asset('icons/accounting-icon.svg')}}" alt="Your Company" :isImage="true">
                        </a>
                    </div>
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            <x-nav-link type="a" href="/warehouses" :active="request()->is('warehouses')">Warehouses</x-nav-link>
                            <x-nav-link type="button" href="/products" :active="request()->is('products')">Products</x-nav-link>
                        </div>
                    </div>
                </div>
                <div class="hidden md:block">
    ...
    <header class="bg-white shadow-sm">
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 flex items-center">
            <h1 class="text-3xl  text-center font-bold tracking-tight text-gray-900">{{$page ?? 1}}</h1>
            {{$backButton ?? ''}}
        </div>
    </header>
    <main>
